    ...
    <section>
      ...
      <div class="container py-5 h-100">
        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="card-body p-md-5 mx-md-4">
                    ...
                    <div class="text-center" >
                      ...
                      <h2 class="mt-1 mb-3 pb-1">Alumni Employment Tracker System</h2>
          ...
          <label for="password" class="form-label" name="password">Password:</label><br>
      ...
      {{-- <div class="mt-3 text-left">
        <span><a href="{{ route('forget') }}" class="forgot">Forgot password?</a></span>
    </div><br> --}}
      <div class="text-center pt-1 mb-5 pb-1">

        <button class="btn btn-primary" name="submit" type="submit">Log

          in</button><br>

                {{-- <div class="mt-3 text-center">
                    <span>Already have an account? <a href="{{ route('register') }}">Register here</a></span>
                </div> --}}
            </div>
